...
# 添加 util 目录到 sys.path
sys.path.append('/dev/shm/gaolanlan/sam2/util')
sys.path.append('../util')
from util.arg_utils import get_base_parser, update_parser, get_savepath  # noqa
from util.model_utils import check_and_download_models  # noqa
from util.webcamera_utils import get_capture, get_writer  # noqa
